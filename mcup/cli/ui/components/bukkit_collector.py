    ...
    def __init__(self):
        ...
        self.add_section(CollectorSection(
            ...
            [
                ...
                CollectorInput("settings/use-map-color-cache", "Enable color cache for maps", CollectorInputType.BOOL,
                               Version(1, 19), LATEST_VERSION),
                CollectorInput("settings/compatibility/allow-old-keys-in-registry", "Allow old keys in registry",
                               CollectorInputType.BOOL, Version(1, 20, 6), LATEST_VERSION),
                CollectorInput("settings/compatibility/enum-compatibility-mode", "Enable enum compatibility mode",
        ...
        self.add_section(CollectorSection(
            ...
            [
                ...
                CollectorInput("spawn-limits/water-underground-creature", "Max water underground creatures",
                               CollectorInputType.INT, Version(1, 18), LATEST_VERSION),
                CollectorInput("spawn-limits/axolotls", "Max axolotls", CollectorInputType.INT,
        ...
        self.add_section(CollectorSection(
            ...
            [
                ...
                CollectorInput("ticks-per/water-underground-creature-spawns",
                               ...
                               CollectorInputType.INT, Version(1, 18), LATEST_VERSION),
                CollectorInput("ticks-per/axolotl-spawns", "Ticks per axolotl spawns", CollectorInputType.INT,
                               Version(1, 18, 1), LATEST_VERSION),
