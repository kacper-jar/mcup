    ...
    def __init__(self):
        ...
        self.add_section(CollectorSection(
            ...
            [
                ...
                CollectorInput("management-server-allowed-origins",
                               "COLLECTOR_SRV_PROP_MANAGEMENT_SERVER_ALLOWED_ORIGINS", CollectorInputType.STRING,
                               CollectorInputMode.ADVANCED, Version(1, 21, 11), LATEST_VERSION),
