        ...
        self.add_section(CollectorSection(
            ...
            [
                CollectorInput("async-chunks/threads", "COLLECTOR_PAPER_GLOBAL_ASYNC_CHUNKS_THREADS",
                               CollectorInputType.INT, CollectorInputMode.ADVANCED, Version(1, 19), Version(1, 19, 1)),
                CollectorInput("chunk-loading/autoconfig-send-distance",
                               "COLLECTOR_PAPER_GLOBAL_CHUNK_LOADING_AUTOCONFIG_SEND_DISTANCE",
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 19), Version(1, 19, 4)),
                CollectorInput("chunk-loading/enable-frustum-priority",
                               ...
                               CollectorInputMode.ADVANCED, Version(1, 19), Version(1, 19, 4)),
                CollectorInput("chunk-loading/global-max-chunk-load-rate",
                               "COLLECTOR_PAPER_GLOBAL_CHUNK_LOADING_GLOBAL_MAX_CHUNK_LOAD_RATE",
                               CollectorInputType.INT, CollectorInputMode.ADVANCED, Version(1, 19), Version(1, 19, 4)),
                ...
                CollectorInput("chunk-loading-advanced/auto-config-send-distance",
                               "COLLECTOR_PAPER_GLOBAL_CHUNK_LOADING_AUTOCONFIG_SEND_DISTANCE",
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 20), LATEST_VERSION),
                CollectorInput("chunk-loading-advanced/player-max-concurrent-chunk-generates",
                               ...
                               CollectorInputType.INT, CollectorInputMode.ADVANCED, Version(1, 20), LATEST_VERSION),
                ...
                CollectorInput("chunk-system/gen-parallelism", "COLLECTOR_PAPER_GLOBAL_CHUNK_SYSTEM_GEN_PARALLELISM",
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 20), Version(1, 21, 8)),
        ...
        self.add_section(CollectorSection(
            ...
            [
                CollectorInput("commands/fix-target-selector-tag-completion",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 19), Version(1, 21, 3)),
                CollectorInput("commands/ride-command-allow-player-as-vehicle",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.BASIC, Version(1, 21, 4), LATEST_VERSION),
        ...
        self.add_section(CollectorSection(
            ...
            [
                ...
                CollectorInput("item-validation/book-size/total-multiplier",
                               ...
                               CollectorInputType.FLOAT, CollectorInputMode.ADVANCED, Version(1, 19), LATEST_VERSION),
        ...
        self.add_section(CollectorSection(
            ...
            [
                ...
                CollectorInput("logging/log-player-ip-addresses",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 19), Version(1, 20, 1)),
        ...
        self.add_section(CollectorSection(
            ...
            [
                CollectorInput("misc/chat-threads/chat-executor-core-size",
                               ...
                               CollectorInputType.INT, CollectorInputMode.ADVANCED, Version(1, 19, 2), LATEST_VERSION),
                ...
                CollectorInput("misc/client-interaction-leniency-distance",
                               ...
                               CollectorInputType.INT, CollectorInputMode.ADVANCED, Version(1, 21), LATEST_VERSION),
                CollectorInput("misc/compression-level", "COLLECTOR_PAPER_GLOBAL_MISC_COMPRESSION_LEVEL",
                               CollectorInputType.STRING, CollectorInputMode.ADVANCED, Version(1, 20, 1),
                               LATEST_VERSION),
                CollectorInput("misc/enable-nether", "COLLECTOR_PAPER_GLOBAL_MISC_ENABLE_NETHER",
                               CollectorInputType.BOOL, CollectorInputMode.BASIC, Version(1, 21, 10), LATEST_VERSION),
                CollectorInput("misc/fix-entity-position-desync",
                               "COLLECTOR_PAPER_GLOBAL_MISC_FIX_ENTITY_POSITION_DESYNC",
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 19), Version(1, 21, 4)),
                CollectorInput("misc/fix-far-end-terrain-generation",
                               "COLLECTOR_PAPER_GLOBAL_MISC_FIX_FAR_END_TERRAIN_GENERATION",
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 21, 11),
                               LATEST_VERSION),
                CollectorInput("misc/lag-compensate-block-breaking",
                               "COLLECTOR_PAPER_GLOBAL_MISC_LAG_COMPENSATE_BLOCK_BREAKING",
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 19), Version(1, 20)),
                ...
                CollectorInput("misc/prevent-negative-villager-demand",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 21, 6), LATEST_VERSION),
                ...
                CollectorInput("misc/xp-orb-groups-per-area", "COLLECTOR_PAPER_GLOBAL_MISC_XP_ORB_GROUPS_PER_AREA",
                               CollectorInputType.INT, CollectorInputMode.ADVANCED, Version(1, 21, 6), LATEST_VERSION),
            ]
        ))
        self.add_section(CollectorSection(
            "Packet Limiter",
        ...
        self.add_section(CollectorSection(
            ...
            [
                CollectorInput("spark/enable-immediately", "COLLECTOR_PAPER_GLOBAL_SPARK_ENABLE_IMMEDIATELY",
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 21), LATEST_VERSION),
                CollectorInput("spark/enabled", "COLLECTOR_PAPER_GLOBAL_SPARK_ENABLED",
                               CollectorInputType.BOOL, CollectorInputMode.BASIC, Version(1, 21), LATEST_VERSION),
            ]
        ))
        self.add_section(CollectorSection(
            "Timings",
        ...
        self.add_section(CollectorSection(
            ...
            [
                CollectorInput("unsupported-settings/allow-grindstone-overstacking",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 19, 2),
                               Version(1, 20, 4)),
                ...
                CollectorInput("unsupported-settings/allow-tripwire-disarming-exploits",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 20, 4),
                               Version(1, 21, 1)),
                CollectorInput("unsupported-settings/allow-unsafe-end-portal-teleportation",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 20, 4), LATEST_VERSION),
                ...
                CollectorInput("unsupported-settings/simplify-remote-item-matching",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 21, 1),
                               Version(1, 21, 4)),
                ...
                CollectorInput("unsupported-settings/skip-vanilla-damage-tick-when-shield-blocked",
                               ...
                               CollectorInputType.BOOL, CollectorInputMode.ADVANCED, Version(1, 20, 6), LATEST_VERSION),
