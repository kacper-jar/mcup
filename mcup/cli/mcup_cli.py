...
class McupCLI:
    ...
    def _register_devtools_commands(self):
        ...
        if self.DEVTOOLS_ENABLED:
            ...
            add_version_parser.add_argument("--buildtools-args", nargs="+", help="Arguments for BuildTools (BUILDTOOLS source only)")
            add_version_parser.add_argument("--installer-args", nargs="+", help="Arguments for installer jar (INSTALLER source only)")
