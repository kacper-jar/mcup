...
- [Getting Started (Installation Guide)](https://mcup.kzl21.ovh/getting-started/installation/)
...
(downloaded from [GitHub repo](https://github.com/kacper-jar/mcup-locker-file))
